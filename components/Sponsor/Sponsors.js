...
export const Sponsors = (props) => {
    ...
    return (
        <div className={styleP.prizesDiv} id="Sponsors">
            ...
            {/* Uncomment the line at the left to bring back Prizes */}
            ...
            <div className={styles.sponsorMargin}>
                ...
                <h3 className={styles.sponsorH3} style={{ color: '#F0AF2E' }}>
                    Gold Tier
                </h3>
                <SponsorsRow sponsors={sponsors} />
                <br />
                <h3 className={styles.sponsorH3} style={{ color: '#1fc4c1' }}>
                    Silver Tier
                </h3>
                <SponsorsRow sponsors={sponsors2} />
                <br />
                <h3 className={styles.sponsorH3} style={{ color: '#ff6161' }}>
                    Ruby Tier
                </h3>
