            ...
            <div className={styles.back}>
                ...
                <div className={styles.grid}>
                    ...
                    <div data-aos="fade-left" className={styles.img}>
                        <img data-aos="rotate-c" src="https://res.cloudinary.com/dlu72yo9b/image/upload/v1632117024/DSC_0838_1_yqfo65.jpg" className={styles.hi}/>
                    </div>
                    <div className={styles.text}>
                        ...
                        fun-packed, interactive workshops ranging from x to y!</p>
                    </div>
                    <div data-aos="fade-left" className={styles.img}>
                        <img data-aos="rotate-c" src="https://res.cloudinary.com/dlu72yo9b/image/upload/v1632116857/DSC02855_saw5id.jpg" className={styles.hi2}/>
                    </div>       
