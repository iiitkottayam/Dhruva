            ...
            <div className={styles.back}>
                ...
                <div className={styles.grid}>
                    <div className={styles.text}>
                        ...
                        <p className={styles.bl} data-aos="fade-up">No Zoom fatigue here. Optimized to create immersive experiences for attendees, Welcome captivates your audience like never before. Interact with attendees by pulling them on stage, allow them to move freely in and out of rooms, provide networking opportunities, and more.</p>
                    </div>
                    ...
                    <div className={styles.text}>
                        ...
                        <p className={styles.bl} data-aos="fade-up">Put speakers at ease by making sure theyre prepped and ready to go. Onboard them in the Green Room and communicate with them while theyre on stage.</p>
                    </div>
                    <div data-aos="fade-left" className={styles.img}>
