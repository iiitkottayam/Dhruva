            ...
            <div className={styles.back}>
                ...
                <div className={styles.grid}>
                    ...
                    <div className={styles.text}>
                        ...
                        <p className={styles.bl}>Put speakers at ease by making sure theyre prepped and ready to go. Onboard them in the Green Room and communicate with them while theyre on stage.</p>
                    </div>
                    <div data-aos="fade-left" className={styles.img}>
